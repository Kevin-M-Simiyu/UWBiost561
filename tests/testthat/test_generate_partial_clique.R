test_that("generate_partial_clique returns correct structure", {
  res <- project561::generate_partial_clique(n = 10, clique_fraction = 0.5,
...
test_that("clique has at least the required number of edges", {
  set.seed(42)
  res <- project561::generate_partial_clique(n = 20, clique_fraction = 0.5,
...
test_that("invalid inputs throw errors", {
  expect_error(project561::generate_partial_clique(n = -1))
  expect_error(project561::generate_partial_clique(n = 10, clique_fraction = 1.5))
  expect_error(project561::generate_partial_clique(n = 10, clique_edge_density = -0.1))
})
