...
library(project561)
set.seed(0)
simulation <- project561::generate_partial_clique(
  n = 10,
  clique_fraction = 0.5,
...
res <- project561::compute_maximal_partial_clique(
  adj_mat = adj_mat,
  alpha = 0.9
)
res
...
```{r check1, out.width = "400px", fig.align="center", echo = FALSE, fig.cap=c('The first screensho')}
knitr::include_graphics("C:/Users/USER/Downloads/561hw3/screenshot2.png")
```

```{r check2, out.width = "400px", fig.align="center", echo = FALSE, fig.cap=c('The second screenshot')}
knitr::include_graphics("C:/Users/USER/Downloads/561hw3/screenshot1.png")
```
